      ...
      <div className="flex h-full  w-full flex-col items-center justify-center">
        <div className="">
          ...
          <p className="mt-1 text-[15px] lg:mt-3">
            Welcome to PaperTrail, the ultimate hub for students to seamlessly
        ...
        <div className="">
          ...
          <p className="mt-1 text-[15px] lg:mt-3">
            PaperTrail is more than just a website; it's a community-driven
            ...
            enthusiastsnand creative minds, all united in the
        ...
        <div className="">
          ...
          <p className="mt-1 text-[15px] lg:mt-3">
            At PaperTrail, our mission is clear: to empower students by
